...
def Y1():
    ...
    def Y_34_price(klfg):       
        ...
        pril_i = {
            ...
            'Объекты общественного назначения': 0.73,
            'Объекты производственного назначения': 0.73,
            'Объекты агропромышленного комплекса': 0.73,
            'Объекты складского назначения': 0.73,
            'Другие объекты строительства': 0.73,
        }
        asas = klfg + 1
